 ...
 * @author Felix Tams
 * This class is based on the MongoDBConnectionHandler from the previous task.
 */
public class MongoDBConnectionHandler {
    ...
    public static void copyCollection(MongoCollection fromCollection, MongoCollection toCollection){
        FindIterable<Document> documents = fromCollection.find();
